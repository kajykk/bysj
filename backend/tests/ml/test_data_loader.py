...
class TestLoadDepresjonData:
    ...
    def test_load_valid(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            f.write(
                "sleep_hours,sleep_quality,exercise_minutes,heart_rate,systolic_bp,diastolic_bp,steps,depression_label\n"
            )
...
class TestLoadKaggleData:
    ...
    def test_load_valid(self):
        ...
        with tempfile.NamedTemporaryFile(
            ...
            f.write(
                "Sleep_Duration_Hours,Heart_Rate_BPM,Physical_Activity_Steps,Mental_Health_Condition\n"
            )
            f.write("7,70,5000,0\n")
            f.write("8,75,8000,1\n")
            path = f.name
