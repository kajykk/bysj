...
class TestPredictStructuredQuality:
    ...
    async def test_complete_data(self, engine: ModelEngine) -> None:
        ...
        features = {
            ...
            "financial_pressure": 2, "family_history": 0, "academic_pressure": 3,
            "exercise_frequency": 2, "anxiety": 2, "panic_attack": 0, "treatment_seeking": 0,
        }
    ...
    async def test_partial_data(self, engine: ModelEngine) -> None:
        ...
        features = {
            ...
            "stress_level": 3, "sleep_duration": 7, "social_support": 4,
            "financial_pressure": 2, "family_history": 0, "academic_pressure": 3,
            "exercise_frequency": 2, "anxiety": 2,  # 缺失 panic_attack 和 treatment_seeking
        }
        result = await engine.predict_structured(features)
    ...
    async def test_poor_data(self, engine: ModelEngine) -> None:
        ...
        features = {
            "age": 20, "gender": 1, "stress_level": 3,
            "sleep_duration": 7, "social_support": 4,
        }
        result = await engine.predict_structured(features)
