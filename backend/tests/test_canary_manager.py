...
from app.services.canary_manager import CanaryManager, TrafficDecision, canary_manager
...
class TestCanaryManagerTrafficDecision:
    ...
    async def _async_test_decide_version_no_canary(self, db_session: AsyncSession) -> None:
        """验证无灰度时返回稳定版本"""
        manager = CanaryManager()
