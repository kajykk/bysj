...
| Current Phase | Phase 5 / Fix & Regression |
| Last Updated | 2026-07-01 (Phase 5 P1 全部修复完成，25/25 P1 已关闭，620/620 回归通过) |
...
| P1 高 | 25 | 0 | 0 | 0 | 0 | 25 | 0 | 0 |
| P2 中 | 60 | 60 | 0 | 0 | 0 | 0 | 0 | 0 |
| P3 低 | 31 | 31 | 0 | 0 | 0 | 0 | 0 | 0 |
| P4 建议 | 4 | 4 | 0 | 0 | 0 | 0 | 0 | 0 |
| **合计** | **123** | **95** | **0** | **0** | **0** | **28** | **0** | **0** |
...
- [x] 所有 P0 已关闭（ISS-072 / ISS-073 / ISS-074 / VIS-015 全部修复 + 214/214 回归通过）
- [x] 所有 P1 已关闭（25/25 P1 全部修复 + 406/406 回归通过，2026-07-01）
- [ ] P2 已关闭或有明确延期说明
