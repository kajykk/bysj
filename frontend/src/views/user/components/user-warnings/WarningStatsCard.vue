<template>
  <el-card class="stats-card">
    <template #header>
      <span class="card-title">{{ t('userWarnings.stats.title') }}</span>
    </template>
    <div
      v-if="loading"
    ...
    >
      ...
      <div class="stat-tile stat-tile--medium">
        ...
        <div class="stat-label">
          {{ t('userWarnings.stats.mediumRisk') }}
        </div>
      </div>
...
defineOptions({ name: 'WarningStatsCard' })
