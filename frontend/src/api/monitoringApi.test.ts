...
describe('api/monitoringApi', () => {
  ...
  it('getDashboardSummary GET /monitoring/dashboard-summary', async () => {
    ...
    expect(dedupedGet).toHaveBeenCalledWith('/monitoring/dashboard-summary')
  })
  ...
  it('getRequestDetailsList 传分页参数', async () => {
    ...
    expect(dedupedGet).toHaveBeenCalledWith('/monitoring/request-details', { params: { limit: 20, offset: 0 } })
  })
  it('getRequestDetail GET /monitoring/request-details/{id}', async () => {
    ...
    expect(dedupedGet).toHaveBeenCalledWith('/monitoring/request-details/1')
  })
})
