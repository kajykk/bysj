...
已知规模数据（2026-09-23 实测，详见评估报告 `reports/2026-09-23_项目全面评估报告.md`）：

- 50 个 API 路由文件（191 个 REST 端点 + 3 个 WebSocket）
- 62 个业务服务文件
- 61 个核心模块
- 40 张数据表（代码声明 39，生产库实测 40）
- 27 个 ML 文件
- 9 个 Docker 服务
- 契约测试全部通过
- 6,160 例后端测试 + 1,119 例前端测试（实测，非估计）
