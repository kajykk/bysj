...
> 5 张关键页面展示。实际项目运行截图可点击 `frontend/src/views/` 下源码查看

### 1. 用户仪表盘

<img src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=SaaS%20dashboard%20for%20mental%20health%20risk%20assessment%2C%20clean%20modern%20UI%2C%20card%20layout%20showing%20risk%20score%20gauge%20chart%2C%20recent%20assessments%20list%2C%20trend%20line%20chart%2C%20notification%20badges%2C%20sidebar%20navigation%2C%20light%20theme%2C%20professional%20medical%20style&image_size=landscape_16_9" width="800" alt="用户仪表盘"/>

### 2. 多模态风险评估

<img src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Web%20form%20interface%20for%20depression%20risk%20assessment%20questionnaire%2C%20slider%20inputs%20for%20PHQ-9%20questions%2C%20progress%20indicator%2C%20text%20input%20for%20free%20text%20analysis%2C%20upload%20zone%20for%20physiological%20data%2C%20modern%20card%20UI&image_size=landscape_16_9" width="800" alt="风险评估页面"/>

### 3. 实时预警监控

<img src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Real-time%20monitoring%20dashboard%20with%20alert%20feed%20sidebar%2C%20line%20charts%20showing%20risk%20trends%20over%20time%2C%20severity%20color%20coded%20badges%2C%20map%20visualization%2C%20live%20notification%20stream%2C%20dark%20theme%20with%20accent%20colors&image_size=landscape_16_9" width="800" alt="实时监控"/>

### 4. 模型治理中心（金丝雀发布 + 漂移检测）

<img src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=Machine%20learning%20model%20management%20interface%20showing%20model%20versions%20table%2C%20accuracy%20metrics%2C%20ROC%20AUC%20charts%2C%20canary%20rollout%20progress%20bar%2C%20drift%20detection%20PSI%20graph%2C%20rollback%20controls%2C%20professional%20dark%20theme&image_size=landscape_16_9" width="800" alt="模型治理"/>

### 5. 报告中心（PDF/Excel 导出）

<img src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=PDF%20report%20preview%20page%20with%20risk%20score%20gauge%2C%20bar%20charts%20for%20modality%20contributions%2C%20recommendations%20list%2C%20export%20to%20PDF%20and%20Excel%20buttons%2C%20timeline%20of%20interventions%2C%20clean%20white%20professional%20layout&image_size=landscape_16_9" width="800" alt="报告中心"/>
